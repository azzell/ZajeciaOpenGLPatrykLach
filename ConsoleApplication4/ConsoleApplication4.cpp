...
void GenerateTextures()
{
	...
	// wczytanie tekstury Venus utworzonej ze zdjêæ sondy Magellan
	// plik: http://maps.jpl.nasa.gov/pix/ven0aaa2.tif
	GLboolean error = load_targa("sat.tga", width, height, format, type, pixels);
	...
	// wczytanie tekstury z hipsometryczn¹ (fizyczn¹) map¹ Ziemi
	// plik: http://maps.jpl.nasa.gov/pix/ear0xuu2.tif
	error = load_targa("sat.tga", width, height, format, type, pixels);
